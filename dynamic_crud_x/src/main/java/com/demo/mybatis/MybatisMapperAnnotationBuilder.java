...
import com.demo.mybatis.injector.DefaultSqlInjector;
    ...
    public void parse() {
        ...
        if (!configuration.isResourceLoaded(resource)) {
            ...
            try {
                ...
                if (com.demo.mybatis.mapper.Mapper.class.isAssignableFrom(type)) {
                    new DefaultSqlInjector().inspectInject(assistant, type);
                }
            } catch (IncompleteElementException e) {
                // ignore
                e.printStackTrace();
